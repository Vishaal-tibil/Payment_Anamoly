...
every engine's *_compute trigger, plus the merchant/individual directory.
Not consumed directly by either persona's UI; these are the batch/admin
operations that produce the data the Analyst and Head of Operations
routers read.
"""
